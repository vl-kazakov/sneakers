    ...
    <div className="wrapper">
      ...
      <div className="content">
        ...
        <div className="content__wrapper">
          <div className="card">
            ...
            <div className="card__item">
              ...
              <button className="button">
                <img width={"11px"} height={"11px"} src="/img/plus.svg" alt="" />
              </button>
            </div>
          </div>
          <div className="card">
            <img width={"133px"} height={"112px"} src="/img/image2.jpg" alt="" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="card__item">
              <div className="card__price">
                <span>цена</span>
          ...
          <div className="card">
            <img width={"133px"} height={"112px"} src="/img/image3.jpg" alt="" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="card__item">
              <div className="card__price">
                <span>цена</span>
          ...
          <div className="card">
            <img width={"133px"} height={"112px"} src="/img/image4.jpg" alt="" />
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="card__item">
              <div className="card__price">
                <span>цена</span>
